export default function About() {
  return (
    <article className="flex flex-col justify-center text-3xl md:text-5xl font-medium tracking-tighter indent-20 bg-white/50 backdrop-blur-lg min-h-screen p-2">
      <h1 className="indent-0">EBRAINS CoCreate Artificial Intelligence Art</h1>

      <p>
        3D Web application to visually communicate convergence of design,
        neurotechnology, neuromorphic computing, Trustworthy AI, and Sustainable
        development.
      </p>
      ...
      <p>
        EBRAINS is a state-of-the-art ecosystem for neuroscience created by the
        EU-funded Human Brain Project.
      </p>
    </article>
  )
}
